...
async function handleCreateRace() {
	...
	try {
		...
		console.log("Error!!! Please Check handleCreateRace function", error);
	}
}
	...
	return new Promise(resolve => {
		...
		const raceInterval = setInterval(async () => {
			const data = await getRace(raceID)
				.catch(error => console.log("Error!! Please Check getRace", error));
			/* 
...
async function runCountdown() {
	try {
		...
		console.log("Error Please check runCountdown" ,error);
	}
}
...
function renderRaceStartView(track, _racers) {
	return `
		<header>
...
async function getTracks() {
	...
	try {
		...
		console.log("Error!!! Please Check getTrack function", err)
	}
...
async function getRacers() {
	...
	try {
		...
		console.log("Error!!! Please check getRacers function", error);
	}
}
...
async function getRace(id) {
	...
	try {
		...
		console.log("Error!!! Please check getRace function: ", error);
	}
}
...
function accelerate(id) {
	...
	try {
		...
		console.log("Error!!! Please Check accelerate function: ", error)
	}
}
